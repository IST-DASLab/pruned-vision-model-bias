...
class MobileNet(nn.Module):
    def __init__(self, channel_multiplier=1.0, min_channels=8, num_classes=1000):
        ...
        self.fc = nn.Linear(self.channels[5], self.num_classes)
...
def mobilenet_025(num_classes=1000):
    return MobileNet(channel_multiplier=0.25, num_classes=num_classes)


def mobilenet_050(num_classes=1000):
    return MobileNet(channel_multiplier=0.5, num_classes=num_classes)


def mobilenet_075(num_classes=1000):
    return MobileNet(channel_multiplier=0.75, num_classes=num_classes)
